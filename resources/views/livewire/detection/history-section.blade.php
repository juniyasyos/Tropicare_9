<div class="grid gap-4 my-4 grid-cols-1 md:grid-cols-3 lg:grid-cols-4">
    @if ($detections->isEmpty())
        <div class="flex flex-col items-center justify-center col-span-full">
            <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" enable-background="new 0 0 512 512"
                viewBox="0 0 512 512" id="empty-folder">
                ...
                <rect width="419.011" height="113.483" x="31.77" y="381.517" fill="none" stroke="#4A486A"
                    stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="10"></rect>
                ...
                <g>
                    <line x1="83.843" x2="72.652" y1="213.182" y2="188.61" fill="none" stroke="#4A486A"
                        stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="10"></line>
                    <line x1="100.224" x2="106.915" y1="205.721" y2="187.84" fill="none" stroke="#4A486A"
                        stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="10"></line>
                    <line x1="67.462" x2="49.581" y1="220.643" y2="213.952" fill="none" stroke="#4A486A"
                        stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="10"></line>
                </g>
                <g>
                    <path fill="#4A486A"
                ...
                l-1.78-12.45c0,0,0-22.5,22.5-22.5S414.489,49.5,414.489,49.5z"></path>
                    ...
                    <line x1="400.989" x2="405.489" y1="28.482" y2="18" fill="none" stroke="#4A486A"
