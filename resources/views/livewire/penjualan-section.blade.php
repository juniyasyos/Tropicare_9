    ...
    <div class="bg-white p-6 pb-20">
        ...
        <div>
            ...
            @else
                ...
                <div class="w-screen -ml-[65px] md:hidden">
                    @foreach ($transactions as $transaction)
                        <div onclick="showTransactionEdit({{ json_encode($transaction) }})"
                            class="p-4 mx-10 bg-white border border-gray-200 rounded-lg shadow flex space-x-5 items-center mb-2 cursor-pointer transition duration-300 ease-in-out transform hover:-translate-y-1 hover:shadow-xl hover:bg-blue-300">
                            <div>
