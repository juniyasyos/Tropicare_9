<div class="container mx-auto p-6">
    ...
    <div
        class="col-span-3 w-[105%] md:w-full bg-white rounded-lg shadow border border-gray-200 dark:bg-gray-800 p-4 md:p-6 md:mt-10 h-auto">
                    ...
                    <h5 class="inline-flex items-center text-gray-500 dark:text-gray-400 leading-none font-normal mb-2">
                        ...
                        <div data-popover id="pendapatan-info" role="tooltip"
                            ...
                            <div class="p-3 space-y-2">
                                <h3 class="font-semibold text-gray-900 dark:text-white">Pendapatan - Total Transaksi
                                </h3>
                                <p>Rekap total pendapatan dari transaksi yang dilakukan. Grafik ini membantu Anda
                                    melihat bagaimana
                                    pendapatan Anda berkembang dari waktu ke waktu. Idealnya, Anda ingin melihat
                                    peningkatan pendapatan
                                    dari periode ke periode untuk mencapai pertumbuhan yang berkelanjutan.</p>
                                <h3 class="font-semibold text-gray-900 dark:text-white">Perhitungan</h3>
                                <p>Total pendapatan dihitung untuk setiap periode waktu tertentu. Ini memberikan
                                    gambaran tentang
                                    bagaimana pendapatan Anda berkembang dari waktu ke waktu berdasarkan transaksi yang
                                    terjadi.</p>
                            </div>
                        </div>
                    </h5>
                ...
                <div>
                    <h5 class="inline-flex items-center text-gray-500 dark:text-gray-400 leading-none font-normal mb-2">
                        ...
                        <div data-popover id="pengeluaran-info" role="tooltip"
                            class="absolute z-50 invisible inline-block text-sm text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm opacity-0 w-72 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-400">
                            <div class="p-3 space-y-2">
                                <h3 class="font-semibold text-gray-900 dark:text-white">Pengeluaran - Total Bulanan</h3>
                                <p>Rekap total pengeluaran bulanan. Grafik ini membantu Anda melihat bagaimana
                                    pengeluaran Anda
                                    berubah dari waktu ke waktu. Idealnya, Anda ingin melihat penurunan pengeluaran dari
                                    bulan ke bulan
                                    untuk meningkatkan efisiensi keuangan Anda.</p>
                                <h3 class="font-semibold text-gray-900 dark:text-white">Perhitungan</h3>
                                <p>Total pengeluaran dihitung untuk setiap bulan yang dipilih dalam rentang waktu
                                    tertentu. Ini
                                    memberikan gambaran tentang bagaimana pengeluaran Anda berkembang dari bulan ke
                                    bulan.</p>
                            </div>
                        </div>
                    </h5>
    ...
    <div class="container mx-auto mt-5 md:mt-10">
        <h5 class="inline-flex text-xl items-center text-gray-500 dark:text-gray-400 leading-none font-semibold py-5">
            Detail Laporan Terfilter
        </h5>
        <div class="grid gap-4 grid-cols-1 md:gap-6 md:grid-cols-2">
            ...
            <div
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div class="text-lg lg:text-xl text-gray-800 dark:text-gray-300 font-semibold">
                        Jumlah Penjualan
                    </div>
                </div>
                <!-- Deskripsi -->
                <div class="text-sm text-gray-600 dark:text-gray-400 mt-2">
                    Semua jumlah transaksi penjualan yang terjadi
                </div>
                <!-- Nilai/Statistik -->
                <div class="text-lg lg:text-xl ml-5 dark:text-gray-100 font-bold mt-4 text-green-400">
            ...
            <div
                ...
                <!-- Deskripsi -->
                <div class="text-sm text-gray-600 dark:text-gray-400 mt-2">
                    Semua jumlah transaksi pengeluaran yang terjadi
                </div>
                <!-- Nilai/Statistik -->
                <div class="text-lg lg:text-xl ml-5 text-red-400 dark:text-gray-100 font-bold mt-4 ">
        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md mt-4">
            ...
            <h5 class="inline-flex items-center text-gray-500 dark:text-gray-400 leading-none font-normal mb-2">
                Info
                <!-- Tanda tanya untuk informasi laba -->
                <svg data-popover-target="laba-info" data-popover-placement="bottom"
                    class="w-3 h-3 text-gray-400 hover:text-gray-900 dark:hover:text-white cursor-pointer ms-1"
                    aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                    viewBox="0 0 20 20">
                    <path
                ...
                <!-- Informasi laba -->
                <div data-popover id="laba-info" role="tooltip"
                    class="absolute z-50 invisible inline-block text-sm text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm opacity-0 w-72 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-400">
                    <!-- Konten informasi laba -->
                    <div class="p-3 space-y-2">
                        <h3 class="font-semibold text-gray-900 dark:text-white">Laba Bersih</h3>
                        <p>Laba adalah selisih antara pendapatan dan pengeluaran, menunjukkan keuntungan bersih dari
                            aktivitas bisnis atau keuangan.</p>
                        <h3 class="font-semibold text-gray-900 dark:text-white">Interpretasi</h3>
                        <p>Jika laba positif, bisnis berhasil mendapatkan keuntungan. Namun, jika laba negatif,
                            bisnis mengalami kerugian.</p>
                    </div>
                </div>
            </h5>
            <!-- Nilai laba -->
            <p class="text-xl font-bold text-green-400">{{ number_format($laba) }}</p>
            <!-- Laba per bulan atau tahun -->
            <div class="mt-4">
                <h6 class="text-base font-semibold text-gray-600 dark:text-gray-400">Laba per {{ $filter_range }}</h6>
                <table class="mt-2 min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        @foreach ($chartData as $data)
                            <tr>
                                ...
                                <!-- Hitung laba secara manual -->
                                @php
                                    $laba = $data['transaction'] - $data['expenditure'];
                                @endphp
                                <td class="px-6 py-4 whitespace-nowrap text-sm {{ $laba >= 0 ? 'text-green-500' : 'text-red-500' }}">
                                    IDR {{ number_format(abs($laba)) }}
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
            ...
            <!-- Pemberitahuan jika laba negatif -->
            @if ($laba < 0)
                <div class="text-red-500 dark:text-red-400 text-sm mt-2">
                    Perhatian: Laba Anda mengalami kerugian.
                </div>
            @endif
        </div>
    </div>
